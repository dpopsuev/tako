module github.com/dpopsuev/tako

go 1.25.8

require (
	github.com/dpopsuev/tangle v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/dpopsuev/oculus/v3 v3.19.0
...
replace github.com/dpopsuev/tangle => ../tangle
