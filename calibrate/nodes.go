...
func (n *LoadScenarioNode) Approach() visual.Element { return visual.ElementEarth }
...
func (n *FanOutCasesNode) Approach() visual.Element { return visual.ElementWater }
...
func (n *WalkCaseNode) Approach() visual.Element { return visual.ElementFire }
...
func (n *ScoreCaseNode) Approach() visual.Element { return visual.ElementEarth }
...
func (n *FanInResultsNode) Approach() visual.Element { return visual.ElementWater }
...
func (n *AggregateNode) Approach() visual.Element { return visual.ElementEarth }
...
func (n *ReportNode) Approach() visual.Element { return visual.ElementAir }
