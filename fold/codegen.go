...
func renderServerCreation(g *ResolvedGraph, productName string) string {
	...
	if len(resolverEntries) > 0 {
		fmt.Fprintf(&b, "\t\t%s.WithSubCircuitResolvers(map[string]tako.AssetResolver{\n", root.Alias)
...
func renderFactoryServer(g *ResolvedGraph, productName string) string {
	...
	if len(g.Schematics) > 0 {
		...
		if len(resolverEntries) > 0 {
			b.WriteString("\tbridgedCfg.SubCircuitResolvers = map[string]tako.AssetResolver{\n")
			for _, entry := range resolverEntries {
				fmt.Fprintf(&b, "%s\n", entry)
			}
			b.WriteString("\t}\n\n")
...
var wiredBinaryTemplate = `// Code generated by tako assemble. DO NOT EDIT.
package main
...
{{ if .NeedsTako }}	tako "github.com/dpopsuev/tako/circuit"
{{ end }}{{ if .NeedsFactory }}	fwmcp "github.com/dpopsuev/tako/mcp"
	fwresource "github.com/dpopsuev/tako/resource"
{{ end }}{{ if .NeedsTools }}	fwtool "github.com/dpopsuev/tako/tool"
{{ end }}{{ if .NeedsInstruments }}	fwdef "github.com/dpopsuev/tako/circuit/def"
	fwengine "github.com/dpopsuev/tako/engine"
{{ end }}	"github.com/dpopsuev/tako/domainserve"
...
var domainServeTemplate = `// Code generated by tako assemble. DO NOT EDIT.
package main
