...
func EmitFinding(bus roster.Bus, f *circuit.Finding) {
...
func DecodeFinding(s *roster.Signal) (circuit.Finding, bool) {
...
func FindingsSince(bus roster.Bus, idx int) []circuit.Finding {
